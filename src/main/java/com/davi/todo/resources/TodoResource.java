package com.davi.todo.resources;
...
import com.davi.todo.services.TodoService;
...
public class TodoResource {
	...
	public ResponseEntity<java.util.List<Todo>> listOpen() {
	...
	public ResponseEntity<java.util.List<Todo>> listClose() {
...
//Acessando outros métodos dentro de "todos"